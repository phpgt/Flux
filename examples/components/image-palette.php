<section id="image-palette-demo" class="demo split" data-flux="flux-first-visible">
	...
	<figure class="palette-preview" data-flux="flux-palette">
		...
		<label class="field"><span>Choose your own image</span><input id="palette-image-file" type="file" accept="image/*" /></label>
		<p id="palette-image-status" role="status"></p>
