<section id="calendar-demo" class="demo" lang="en-GB" data-flux="flux-first-visible flux-date (flux-date@#calendar-connection)">
	<h2>Calendar progress</h2><p>The bars track local calendar progress. Weeks start on Monday. Date names follow the nearest HTML <code>lang</code> attribute; time follows your device's time zone.</p>
