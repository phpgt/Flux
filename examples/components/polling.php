<section id="polling-demo" class="demo" data-flux="flux-first-visible">
	...
	<p>PHP renders each time when the page is requested. The elements use <code>data-flux="live"</code> or <code>data-flux="live-inner"</code> with <code>data-flux-rate="5"</code> to request updates every five seconds while visible. Polling pauses when these elements leave the viewport or the tab is hidden.</p>
