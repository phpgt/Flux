...
<p>Flux is a <a href="https://www.php.gt/" target="_blank">PHP.GT</a> project, intended to provide progressive enhancement by default in <a href="https://www.php.gt/webengine" target="_blank">WebEngine</a> projects. It can also be used independently, as these examples demonstrate.</p>
...
<p>Each example below is achieved by adding <code>data-flux</code> attributes to HTML elements using standard HTTP forms to POST their data to PHP, where appropriate. No JavaScript was written for these examples to work.</p>

<?php foreach(['clock', 'todo', 'gauge', 'levels', 'search'] as $example) demo($example); ?>
