...
<main class="page-shell">
	...
	<p><a href="/test/fixtures/example/">All examples</a> · <a href="09-css-geometry.php">Geometry</a> · <a href="10-css-controls.php">Control properties</a></p>
	<figure id="image-palette" class="panel palette-preview" data-flux="flux-palette">
		<img src="/test/fixtures/example/assets/palette.svg" width="640" height="360" alt="An illustration of hills beneath a golden sun" />
	...
	<figure id="video-palette" class="panel palette-preview" data-flux="flux-palette">
		<video controls muted loop playsinline width="320" height="180" preload="auto" src="/test/fixtures/example/assets/palette.webm" aria-label="A silent colour study with gradually changing hues"></video>
