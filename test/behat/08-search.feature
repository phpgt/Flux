...
Feature: Search autocomplete example
  Scenario: Search results preview without taking over normal form submission
    Given I am on "/test/fixtures/example/08-search.php"
    ...
    And the current URL path should be "/test/fixtures/example/08-search.php"
    ...
    And the current URL path should be "/test/fixtures/example/08a-search-results.php"
